...
class GridItem extends _react.default.Component /*:: <Props, State>*/{
  constructor() {
     ...
     */
    _defineProperty(this, "onResizeStop", (e, callbackData) => {
     ...
     * @param  {Object} callbackData  an object with node and size information
     */
    _defineProperty(this, "onResizeStart", (e, callbackData) => {
     ...
     * @param  {Object} callbackData  an object with node and size information
     */
    _defineProperty(this, "onResize", (e, callbackData) => {
  ...
  mixinResizable(child /*: ReactElement<any>*/, position /*: Position*/, isResizable /*: boolean*/) /*: ReactElement<any>*/{
    ...
    const maxWidth = (0, _calculateUtils.calcGridItemPosition)(positionParams, 0, 0, cols - x, 0).width;
   ...
   */
  onResizeHandler(e /*: Event*/, _ref4 /*:: */, handlerName /*: string*/) /*: void*/{
    let {
      node,
      size
    } /*: { node: HTMLElement, size: Position }*/ = _ref4 /*: { node: HTMLElement, size: Position }*/;
    ...
    let {
      w,
      h
    } = (0, _calculateUtils.calcWH)(this.getPositionParams(), size.width, size.height, x, y);
